...
class Sabre(object):
    ...
    APIS = {
        ...
        'GET', '/v1/lists/supported/shop/flights/origins-destinations', 'City Pairs Lookup API'),
        ...
        'GET', '/v1/lists/supported/pointofsalecountries', 'Point of Sale Country Code Lookup API'),
        'v1.lists.supported.shop.themes.theme': (
        'GET', '/v1/lists/supported/shop/themes/{theme}', 'Theme Airport Lookup API'),
        'v1.auth.token': ('POST', '/v1/auth/token', 'Authentication Request'),
        'v1.lists.utilities.airlines.alliances': (
        'GET', '/v1/lists/utilities/airlines/alliances/', 'Airline Alliance Lookup API'),
        ...
        'v1.lists.supported.cities.airports': (
        'GET', '/v1/lists/supported/cities/{city}/airports/', 'Airports at Cities Lookup API'),
        ...
        'GET', '/v1/lists/supported/historical/seasonality/airports', 'Travel Seasonality Airports Lookup API'),
        ...
        'GET', '/v1/historical/flights/{destination}/seasonality', 'Travel Seasonality API'),
        'v1.lists.utilities.airlines.': ('GET', '/v1/lists/utilities/airlines/', 'Airline Lookup API'),
        'v1.lists.utilities.aircraft.equipment': (
        'GET', '/v1/lists/utilities/aircraft/equipment/', 'Aircraft Equipment Lookup API'),
    ...
    def __init__(self, client_id, client_secret, server='https://api.test.sabre.com'):
        ...
        for api_name, (method, endpoint, description) in self.APIS.items():
            ...
            def fn(s, endpoint, *args, **kwargs):
                ...
                assert result.status_code is 200, u"Got a {} (expecting 200): {}".format(result.status_code,
                                                                                         result.json())
                return result.json()
